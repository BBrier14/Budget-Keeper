...
!(function(t, e) {
			...
			(Z = (function() {
				...
				return (
					...
					(t._slide = function(t, e) {
						...
						if (
							(t === W ? ((n = q), (i = z), (r = U)) : ((n = G), (i = X), (r = B)), l && k(l).hasClass(Q))
						)
							this._isSliding = !1;
	...
	function Lt(t) {
		...
		return i && 'BODY' !== i && 'HTML' !== i
			? -1 !== [ 'TD', 'TABLE' ].indexOf(n.nodeName) && 'static' === Dt(n, 'position') ? Lt(n) : n
						...
						var c = i.priority,
							...
							h = {
								primary: function(t) {
									var e = f[t];
									return (
										f[t] < l[t] && !i.escapeWithReference && (e = Math.max(f[t], l[t])),
										Ut({}, t, e)
									);
								},
								secondary: function(t) {
									...
									return (
										f[t] > l[t] &&
											...
											(n = Math.min(f[e], l[t] - ('right' === t ? f.width : f.height))),
										Ut({}, e, n)
									);
								}
							};
				...
				arrow: {
					...
					fn: function(t, e) {
						...
						return (
							...
							(t.arrowElement = i),
							(t.offsets.arrow = (Ut((n = {}), h, Math.round(E)), Ut(n, u, ''), n)),
							t
						);
					},
					element: '[x-arrow]'
	...
	var me,
		...
		(Fe = 'right-start'),
		(Ue = 'left-start'),
		(Be = { offset: 0, flip: !0, boundary: 'scrollParent', reference: 'toggle', display: 'dynamic' }),
		(Ke = {
			...
			return (
				...
				(t._getPlacement = function() {
					...
					return (
						t.hasClass(De)
							...
							: t.hasClass(Ae)
								? (e = Fe)
								: t.hasClass(Se) ? (e = Ue) : me(this._menu).hasClass(Oe) && (e = We),
						e
					);
				}),
				...
				(l._jQueryInterface = function(e) {
					return this.each(function() {
						...
						if (
							(t || ((t = new l(this, 'object' == typeof e ? e : null)), me(this).data(ve, t)),
							'string' == typeof e)
						) {
								...
								if (
									...
									me(i).trigger(a),
										a.isDefaultPrevented() ||
											('ontouchstart' in document.documentElement &&
												me(document.body).children().off('mouseover', null, me.noop),
					...
					if (
						(/input|textarea/i.test(t.target.tagName)
							? !(
									32 === t.which ||
									(27 !== t.which &&
										((40 !== t.which && 38 !== t.which) || me(t.target).closest(Pe).length))
								)
							: Te.test(t.which)) &&
						(t.preventDefault(), t.stopPropagation(), !this.disabled && !me(this).hasClass(we))
					) {
			...
			return (
				...
				(t.setElementContent = function(t, e) {
					...
					'object' == typeof e && (e.nodeType || e.jquery)
						? n ? an(e).parent().is(t) || t.empty().append(e) : t.text(an(e).text())
						: t[n ? 'html' : 'text'](e);
				}),
				(t.getTitle = function() {
				...
				(i._jQueryInterface = function(n) {
					return this.each(function() {
						...
						if (
							...
							(t || ((t = new i(this, e)), an(this).data(cn, t)), 'string' == typeof n)
						) {
							if ('undefined' == typeof t[n]) throw new TypeError('No method named "' + n + '"');
							t[n]();
						}
				...
				(i._jQueryInterface = function(n) {
					return this.each(function() {
						...
						if (
							...
							(t || ((t = new i(this, e)), On(this).data(kn, t)), 'string' == typeof n)
						) {
							if ('undefined' == typeof t[n]) throw new TypeError('No method named "' + n + '"');
							t[n]();
						}
		...
		(Jn = { ACTIVATE: 'activate' + Gn, SCROLL: 'scroll' + Gn, LOAD_DATA_API: 'load' + Gn + '.data-api' }),
		(Zn = 'dropdown-item'),
		($n = 'active'),
		(ti = {
		...
		(ii = (function() {
			...
			return (
				...
				(t._activate = function(e) {
					...
					var n = Vn(t.join(','));
					n.hasClass(Zn)
						? (n.closest(ti.DROPDOWN).find(ti.DROPDOWN_TOGGLE).addClass($n), n.addClass($n))
						: (n.addClass($n),
				...
				(n._jQueryInterface = function(e) {
					return this.each(function() {
						...
						if (
							(t || ((t = new n(this, 'object' == typeof e && e)), Vn(this).data(Yn, t)),
							'string' == typeof e)
						) {
							if ('undefined' == typeof t[e]) throw new TypeError('No method named "' + e + '"');
							t[e]();
